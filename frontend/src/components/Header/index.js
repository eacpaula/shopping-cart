...
export default function Header(props) {
  ...
  const [updateInfo, setUpdateInfo] = React.useState(updateBadge)
  ...
  useEffect(() => {
    if (cart && cart.products && Array.isArray(cart.products)) {
      let total = cart.products.reduce((n, {quantity}) => n + quantity, 0)
      setQuantity(total)
    }

		setUpdateInfo(false)
	}, [cart, quantity, updateInfo])
